...
public class example23 {
    public static void main(String[] args) {
        ...
        System.out.println(String.format("Reference queue does %scontain references",
        ...
        while ((shoppingCartReferece = (WeakReference<ShoppingCart>) referenceQueue.poll()) != null) {
            System.out.println(String.format("Reference was %scleared",
                    shoppingCartReferece.get() == null ? "": "not "));
        }
    }
}
